                ...
                <v-card-text class="pb-0">
                    <v-container> 
                        <v-form ref="form">
                            ...
                            <!-- <div id="app">
                            <div id='agency' style=" padding-bottom: 30px; width:auto;">
                                <ejs-combobox id='combobox' :dataSource='agency' placeholder='Agency'></ejs-combobox>
                            </div>
                            </div> -->
                            ...
                            <v-select outlined color="black" v-model="form.agency" label="Agency" required :rules="inputRules" :items="itemsAgency"></v-select>
                            ...
                            <v-text-field outlined color="black" class="textfield"  v-model="form.package" label="Extra" :rules="inputRules"></v-text-field>

                            <v-select outlined color="black" v-model="form.extra" label="Extra" required :rules="inputRules" multiple persistent-hint :items="itemsExtra"></v-select>
...
//Import style untuk component  Combobox
import Vue from 'vue';
...
export default {
    ...
    data () {
        ...
        //   },
            ...
            error_message: '',
            color: '',
            itemsAgency:['HYBE', 'SM', 'JYP', 'YG'],
            itemsExtra:['Poster', 'Photocard', 'Sticker'],
            headers: [
                {text: "Merchandies Name", value: "album"},
